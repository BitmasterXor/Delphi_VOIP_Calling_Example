...
type
  TForm1 = class(TForm)
    ...
    Button1: TButton; // Button to start connection
    WaveOut: TunavclWaveOutDevice; // Audio output device (speakers)
    CodecOut: TunavclWaveCodecDevice; // Codec for audio output
...
begin
  ...
  Form1.WaveOut.close(); // Close speaker output
  Form1.CodecOut.close(); // Close codec
